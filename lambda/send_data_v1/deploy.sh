...
config_update=$(aws lambda update-function-configuration --function-name $function_name --environment "Variables={callback_base_url=https://f195-2401-4900-52fd-3b77-4083-b14f-d858-195a.ngrok-free.app}")
